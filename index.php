...
apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "<b>You Are Banned</b>🚫\nGet Out Of Here Idiot🖕" ,"parse_mode" =>"HTML"));	
	...
	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "🗣 has been sent." ,"parse_mode" =>"HTML"));
    ...
    apiRequest("sendphoto", array('chat_id' => $membersidd[$y], "photo" => $substtr,"caption" =>$caption));
		...
		$memcout = count($membersidd)-1;
	 	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "📦 your message".$memcout."Contact was sent..","parse_mode" =>"HTML",'reply_markup' => array(
...
if($chat_id==$admin){
  apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" => 'Hello sir around Mdyd😉Bray call on Ryplay and write your text message to Trading 😎Bray ⚓️ Help️ press the button 👌😃.',"parse_mode"=>"MARKDOWN", 'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
...
apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" =>"📝 welcome to 👇".$starttext.""."👆found."));
...
.', 'reply_markup' => array(
        ...
        'resize_keyboard' => true)));
    		...
    		apiRequest("sendMessage", array('chat_id' => $admin, "text" => "`To reply message to Ryplay`
🔷 comments available list:

🔹`1.` * /ban *
 The audience on the black list (with Ryplay)
-------------------------------
🔹`2. `* /unban *
 Delete a contact from the blacklist (with Ryplay)
-------------------------------
🔹`3. `* /setstart *
If someone enters your robot and * /start * he sent this message to him * /setstart * check and continue to write your text.
Example :
* /setstart * Hi, how are you? If you have a message for me here Bfrst😃
-------------------------------
🔹`4. `* /setdone *
If someone sends you a message in the robot to be sent this message to him.
Example :
* /setdone * Wait until the answer I got your message
...
.","parse_mode" =>"MARKDOWN",'reply_markup' => array(
        ...
        $pmembersid= explode("\n",$txxt);
    		...
    		apiRequestJson("sendMessage", array('chat_id' => $chat_id,"parse_mode"=>"HTML", "text" => 'Clean the contacts list ✔️.', 'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
        ...
        $pmembersid= explode("\n",$txxt);
    		...
    		apiRequestJson("sendMessage", array('chat_id' => $chat_id,"parse_mode"=>"HTML", "text" => 'Black List was cleared ✔', 'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
    		...
    		apiRequestJson("sendMessage", array('chat_id' => $chat_id, "text" => 'Hello sir around Mdyd😉Bray call on Ryplay and write your text message to Trading 😎Bray ⚓️ Help️ press the button 👌😃.', 'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
          ...
          apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "📦 send your message." ,"parse_mode" =>"HTML"));
      $boolean = file_get_contents('booleans.txt');
		  $booleans= explode("\n",$boolean);
    ...
    $texttoall =$text;
		...
		$mmemcount = count($membersidd) -1;
		 apiRequestJson("sendMessage", array('chat_id' => $chat_id,"parse_mode" =>"HTML", "text" => "✅ total number of audiences:".$mmemcount,'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
		...
		$membersidd= explode("\n",$txtt);
		$mmemcount = count($membersidd) -1;
		 apiRequestJson("sendMessage", array('chat_id' => $chat_id,"parse_mode" =>"HTML", "text" => "🚫 total number of people that are on the black list:".$mmemcount,'reply_markup' => array(
        'keyboard' => array(array('🗣 Send To All'),array('⚓️ Help','👥 Members','❌ Blocked Users'),array("Settings ⚙")),
        'one_time_keyboard' => true,
        'selective' => true,
        'resize_keyboard' => true)));
...
➖➖➖➖➖➖➖➖➖➖➖
Was added to the blacklist." ,"parse_mode" =>"HTML"));
    		}
    	if($text == "/unban"){
...
------------------
Was removed from the black list." ,"parse_mode" =>"HTML"));
		apiRequest("sendMessage", array('chat_id' => $rpto, "text" => "<b>You Have Been UnBanned⚙,</b>
-----------------
Severe clean your black list ⚙." ,"parse_mode" =>"HTML"));
    		}
    	}
	}
  } else {
